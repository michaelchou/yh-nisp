<template>
   <div class="x-modal">
		...
		<p style="text-align:center;font-size:2.7rem;top:30%;position: relative;">电子签名故障，是否继续办理业务？</p>

		<div class="modal_btnbox">
			<button class="btn" id="btn_back1">结束办理</button>
			<button class="btn" id="btn_sure1">继续办理</button>
		</div>
	</div>
</template>
